...
final adRewardedCoinsProvider = FutureProvider.autoDispose<RewardedAd?>((
  ref,
) async {
  final ad = await AdsService.showRewardedCoinsAd();

  return ad;
});

final adRewardedLivesProvider = FutureProvider.autoDispose<RewardedAd?>((
  ref,
) async {
  final ad = await AdsService.showRewardedLivesAd();
