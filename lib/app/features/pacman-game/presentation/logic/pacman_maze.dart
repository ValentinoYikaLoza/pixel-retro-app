...
class PacmanMaze {
  ...
  /// Spawn por defecto: pasillo caminable más bajo que cruza el centro.
  Point<int> _defaultSpawn() {
    for (var y = height - 1; y >= 0; y--) {
      if (isWall(13, y) || isWall(14, y)) continue;
      return Point(13, y);
    }
...
/// Mapa del nivel 1 (validado). Las paredes son simétricas y todos los
/// comestibles son alcanzables; la fila de túnel (sin pared en los bordes)
